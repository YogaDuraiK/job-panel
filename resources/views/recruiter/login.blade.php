...
<div class="container" style="margin-top: 30px;">
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="row">
                <div class="col-sm-6">
                    <h2 class="contact-title">Recruiter Login</h2>
                </div>
                <div class="col-sm-6" style="text-align:right;">
                    <div class="form-group">
                        <a href="{{url('recruiter-register')}}" class="button button-contactForm boxed-btn">Register</a>
                    </div>
                </div>
            </div>

            <form class="form-contact contact_form" method="POST" action="{{ url('recruiter') }}">
                @csrf
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
